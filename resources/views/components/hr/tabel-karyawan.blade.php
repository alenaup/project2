                ...
                <tbody>
                    ...
                    <template x-for="(emp, index) in employees" :key="emp.id_user">
                        <tr class="odd:bg-white even:bg-gray-100 shadow-sm hover:bg-green-50 transition cursor-pointer"
                            ...
                            <td class="p-3 text-left whitespace-nowrap font-medium text-gray-900" x-text="emp.nama_lengkap"></td>
                            <td class="p-3 text-left whitespace-nowrap" x-text="emp.outsourcing ? emp.outsourcing.nama_outsourcing : '-'"></td>
                            ...
                            <td class="p-3 text-center whitespace-nowrap">
                                <span class="px-2 py-1 rounded text-xs font-semibold"
                                      :class="emp.status === 'active' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'"
        ...
        <div class="flex flex-wrap justify-end mt-6 gap-1 text-sm" x-show="lastPage > 1">
            ...
            <template x-for="page in paginationRange()" :key="page">
                <button 
                    ...
                    :class="currentPage === page ? 'bg-green-600 text-white' : 'hover:bg-green-600 hover:text-white border hover:border-transparent'"
                    x-text="page">
                </button>
            </template>
